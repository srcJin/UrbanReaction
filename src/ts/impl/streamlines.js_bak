...
console.log("-------------------");
console.log("streamlines.ts running!");
/**
...
export default class StreamlineGenerator {
    ...
    samplePoint() {
        ...
        return new Vector(Math.random() * this.worldDimensions.x, Math.random() * this.worldDimensions.y)
            .add(this.origin);
    }
    /**
